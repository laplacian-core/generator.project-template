...
- [src/scripts/{each project.subprojects as subproject}/{hyphen subproject.group}-{hyphen subproject.name}/update-project.hbs.sh](<./src/scripts/{each project.subprojects as subproject}/{hyphen subproject.group}-{hyphen subproject.name}/update-project.hbs.sh>)
